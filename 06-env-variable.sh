...
#[ ec2-user@ip-172-31-28-70 ~/shell-sessions- ]$ cd ( if u given this it will be directly land into ec2 home folder)
...
#source .bashrc
#logout ayyi login chesi again meeru run chesina same shell ani print avuthundhi
